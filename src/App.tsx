...
function MezziDataList({ id }: { id: string }) {
  return (
    <datalist id={id}>
      {MEZZI.map(m => <option key={id+mezzoLabel(m)} value={mezzoLabel(m)} />)}
    </datalist>
  );
}
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              <div style={{ display:"flex", gap:12, flexWrap:"wrap" }}>
                ...
                <div style={{ flex:1, minWidth:140 }}>
                  ...
                  <FieldInput placeholder="Cerca per nome, numero o targa…" value={form.plate} list="mezzi-datalist-new"
                    onChange={v=>{
                  ...
                  <MezziDataList id="mezzi-datalist-new"/>
                  ...
                  <div style={{ background:"var(--fuori-uso-bg)", border:"1px solid var(--fuori-uso-text)33", borderRadius:10, padding:"16px", display:"flex", flexDirection:"column", gap:12 }}>
                    <div style={{ display:"flex", gap:10, flexWrap:"wrap" }}>
                      <div style={{ flex:1, minWidth:130 }}>
                        <Label text="Targa / ID Mezzo *"/>
                        <FieldInput placeholder="Cerca per nome, numero o targa…" value={fuForm.plate} list="mezzi-datalist-fu"
                          onChange={v=>{
                            const m = MEZZI_BY_LABEL.get(v);
                            setFuForm(f=>({ ...f, plate:v, vehicleType: m ? m.categoria : f.vehicleType }));
                          }} error={fuErrors.plate}
                        ...
                        <MezziDataList id="mezzi-datalist-fu"/>
