...
async function logUserActivity(username: string, role: string) {
  return sbFetch("user_activity", { method:"POST", headers:{"Prefer":"return=minimal"}, body: JSON.stringify({ username, role }) });
}
async function getUserActivity() {
  return sbFetch("user_activity?select=username,role,logged_at&order=logged_at.desc&limit=1000");
}
...
async function insertMessage(author: string, text: string) {
  return sbFetch("messages", { method: "POST", headers: { "Prefer": "return=minimal" }, body: JSON.stringify({
...
const MEZZI: Mezzo[] = [
  ...
  { descrizione:"AutoPanda", numero:"15", targa:"BP826JZ", categoria:"Auto" },
  { descrizione:"AutoIveco", numero:"20", targa:"DG677KR", categoria:"Auto" },
  { descrizione:"AutoSuzuki", numero:"25", targa:"BX105EC", categoria:"Auto" },
  { descrizione:"AutoClasse A", numero:"30", targa:"BM175TC", categoria:"Auto" },
  { descrizione:"AutoFox Vw", numero:"35", targa:"DF467GD", categoria:"Auto" },
  { descrizione:"AutoCaddy", numero:"40", targa:"SI346820", categoria:"Auto" },
  { descrizione:"Bandiera inox scarico liquidi", numero:"203", targa:"", categoria:"Bandiera" },
  { descrizione:"Contenitore fondo apribile", numero:"76", targa:"", categoria:"Contenitore" },
  { descrizione:"Contenitore per manutenzione aerea", numero:"78", targa:"", categoria:"Contenitore" },
  { descrizione:"Cestello sospeso per sollevamento", numero:"79", targa:"", categoria:"Cestello" },
  { descrizione:"SKID Acido solforico", numero:"A22", targa:"", categoria:"SKID" },
  { descrizione:"Benna Blu B2530/1800 S", numero:"64", targa:"S25930108", categoria:"Benna" },
  { descrizione:"BennaMZGL 10000-3n° 1", numero:"65", targa:"7601", categoria:"Benna" },
  { descrizione:"BennaMZGL10000-4 n°2", numero:"66", targa:"2105", categoria:"Benna" },
  { descrizione:"BennaMZGL 10000-4 n° 3", numero:"67", targa:"Serie 2268", categoria:"Benna" },
  { descrizione:"BennaMZGL 10000-4B n° 4", numero:"68", targa:"Serie 013590", categoria:"Benna" },
  { descrizione:"Benna rossa n° 5 B2640_800S", numero:"69", targa:"S27010109", categoria:"Benna" },
  { descrizione:"Benna Nuova B2530_1000", numero:"70", targa:"S25800/22", categoria:"Benna" },
  { descrizione:"CarrelloOTO35", numero:"50", targa:"C3500212", categoria:"Carrello" },
  { descrizione:"CarrelloHyster H16", numero:"51", targa:"G019E02112F", categoria:"Carrello" },
  { descrizione:"Carrello Hyster H3", numero:"52", targa:"LI77B30681H", categoria:"Carrello" },
  { descrizione:"CarrelloOTO45", numero:"53", targa:"C4500114", categoria:"Carrello" },
  { descrizione:"CarrelloHyster H9", numero:"54", targa:"B299E01650M", categoria:"Carrello" },
  { descrizione:"CarrelloLinde H80", numero:"55", targa:"E1X353R00710", categoria:"Carrello" },
  { descrizione:"CarrelloLinde H25", numero:"56", targa:"GR AA962", categoria:"Carrello" },
  { descrizione:"CarrelloHyster H12", numero:"57", targa:"H007E02228F", categoria:"Carrello" },
  { descrizione:"CarrelloHyster H12", numero:"59", targa:"H007E02244F", categoria:"Carrello" },
  { descrizione:"CarrelloHyster 700XL", numero:"62", targa:"F006A08724T", categoria:"Carrello" },
  { descrizione:"CarrelloHyster H7_N", numero:"63", targa:"K006E01598L", categoria:"Carrello" },
  { descrizione:"CarrelloHyster H28", numero:"90", targa:"E008E01840Y", categoria:"Carrello" },
  { descrizione:"EscavatoreCaterpillar", numero:"270", targa:"CAT0313FPGJD10099", categoria:"Escavatore" },
  { descrizione:"Gruppo elettrogeno Mosa Kw 16 GE22 VSX", numero:"205", targa:"34240100000", categoria:"Gruppo Elettrogeno" },
  { descrizione:"Gruppo Elettrogeno Bove Kw 100 GE125FSS", numero:"206", targa:"1071058", categoria:"Gruppo Elettrogeno" },
  { descrizione:"Gruppo Elettrogeno Bove Kw4 GE5000SS", numero:"207", targa:"GH1702212", categoria:"Gruppo Elettrogeno" },
  { descrizione:"Gruppo Elettrogeno Bove Kw 12GQ16PSS", numero:"208", targa:"U519769E", categoria:"Gruppo Elettrogeno" },
  { descrizione:"Gruppo Elettrogeno Bove Kw 8 GQ11PSS", numero:"209", targa:"U19389E", categoria:"Gruppo Elettrogeno" },
  { descrizione:"Gru Gottwald", numero:"400", targa:"SP210/91", categoria:"Gru" },
  { descrizione:"Minipala 242", numero:"83", targa:"CAT0242BJSRS02272", categoria:"Minipala" },
  { descrizione:"Minipala 262", numero:"84", targa:"CAT0262DTW6E00904", categoria:"Minipala" },
  { descrizione:"Motopala 930", numero:"85", targa:"AGF551_tfw00720", categoria:"Motopala" },
  { descrizione:"Motopala 930", numero:"86", targa:"CAT0930MHKTG01089", categoria:"Motopala" },
  { descrizione:"Motopala 930", numero:"87", targa:"AFY501_tfw00607", categoria:"Motopala" },
  { descrizione:"Motopala 924", numero:"88", targa:"CAT0924GPWGX00687/AFD610", categoria:"Motopala" },
  { descrizione:"Motopala 938", numero:"89", targa:"CAT0938HELKM01150/AHM649", categoria:"Motopala" },
  { descrizione:"Motopala 926", numero:"92", targa:"CAT0926MKW5L01083", categoria:"Motopala" },
  { descrizione:"Motopala 928", numero:"93", targa:"CAT0928GP7SR02163/ANAE875", categoria:"Motopala" },
  { descrizione:"Kalmar", numero:"95", targa:"NBDABDAB3S048115", categoria:"Kalmar" },
  { descrizione:"Polipo Elettroidraulico", numero:"900", targa:"34.26.97", categoria:"Polipo" },
  { descrizione:"Semirimorchio Acerbi", numero:"300", targa:"LI 9624", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Miele", numero:"301", targa:"AA02187", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio A.V.", numero:"302", targa:"AF75173", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Rolfo", numero:"303", targa:"AA89137", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Saab", numero:"304", targa:"CO018073", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Rolfo", numero:"305", targa:"XA379CL", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Cardi", numero:"306", targa:"FI034721", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Cardi", numero:"307", targa:"LU008933", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Zorzi", numero:"308", targa:"XA856ES", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Cometto", numero:"309", targa:"AA31018", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Superstar", numero:"310", targa:"XA364NN", categoria:"Semirimorchio" },
  { descrizione:"Semirimorchio Bernard", numero:"311", targa:"AC07138", categoria:"Semirimorchio" },
  { descrizione:"Trattore Scania", numero:"107", targa:"DB820PD", categoria:"Trattore" },
  { descrizione:"Trattore Scania", numero:"108", targa:"BH092RL", categoria:"Trattore" },
  { descrizione:"Trattore Daf", numero:"110", targa:"GX866XM", categoria:"Trattore" },
  { descrizione:"Trattore Scania", numero:"111", targa:"BP981NX", categoria:"Trattore" },
  { descrizione:"Trattore Mangime", numero:"118", targa:"BY044AM", categoria:"Trattore" },
  { descrizione:"Tramoggia 1", numero:"73", targa:"100cpt/11", categoria:"Tramoggia" },
  { descrizione:"Tramoggia 2", numero:"74", targa:"101cpt/11", categoria:"Tramoggia" },
  { descrizione:"Tramoggia 3", numero:"75", targa:"", categoria:"Tramoggia" },
];
const mezzoLabel = (m: Mezzo) => `${m.descrizione} · n°${m.numero}${m.targa ? " · " + m.targa : ""}`;
const MEZZI_BY_LABEL = new Map(MEZZI.map(m => [mezzoLabel(m), m]));
...
async function getUserRole(username: string): Promise<Role> {
  try {
    const data = await sbFetch(`users?username=eq.${encodeURIComponent(username)}&select=role,blocked`);
    if (data && data[0]) {
      if (data[0].blocked) return 'operator';
      return data[0].role as Role;
    }
    // Nuovo utente → crea con ruolo operator
    await sbFetch("users", {
      method: "POST",
      headers: { "Prefer": "return=minimal" },
      body: JSON.stringify({ username, role: 'operator' })
    }).catch(() => {});
    return 'operator';
...
function FieldInput({ value, onChange, placeholder, error, style={}, list }: { value: string; onChange: (v: string) => void; placeholder: string; error?: boolean; style?: React.CSSProperties; list?: string }) {
  return <input value={value} onChange={e=>onChange(e.target.value)} placeholder={placeholder} list={list} autoComplete="off"
...
function MezzoSelect({ value, isCustom, onSelect, onCustomToggle, onCustomChange, error, accent, category, mezziList }:
  ...
  return (
    <>
      {!isCustom ? (
        <select value={value} disabled={!category} onChange={e=>{ e.target.value===MEZZI_CUSTOM ? onCustomToggle() : onSelect(e.target.value); }}
          style={{ width:"100%", background:"var(--input-bg)", color:value?"#cce0f5":"#2a4a6e", border:`1px solid ${error?RED:BORDER}`, borderRadius:8, padding:"12px 14px", fontSize:14, fontFamily:"inherit", opacity:category?1:0.6, cursor:category?"pointer":"not-allowed" }}>
          <option value="">{category ? "— Seleziona mezzo —" : "— Seleziona prima il tipo di mezzo —"}</option>
          {category && filtered.map(m => (
            <option key={mezzoLabel(m)} value={mezzoLabel(m)}>{m.descrizione} — n°{m.numero}{m.targa ? " — "+m.targa : ""}</option>
          ))}
          {category && <option value={MEZZI_CUSTOM}>✎ Mezzo non in elenco (inserisci manualmente)</option>}
        </select>
      ) : (
        <div style={{ display:"flex", gap:8, alignItems:"center" }}>
          <FieldInput placeholder="Es. PRT-0042" value={value} onChange={onCustomChange} error={error}
            style={{ fontFamily:"Barlow Condensed, sans-serif", fontWeight:800, fontSize:16, letterSpacing:3, textTransform:"uppercase", color:accent }}/>
          <button type="button" onClick={onCustomToggle} title="Torna all'elenco mezzi"
            style={{ fontFamily:"Barlow Condensed, sans-serif", fontWeight:700, cursor:"pointer", flexShrink:0, padding:"10px 12px", borderRadius:7, fontSize:12, background:"var(--input-bg)", color:"var(--sub)", border:`1px solid ${BORDER}` }}>↺</button>
        </div>
      )}
    </>
  );
...
export default function App() {
  ...
  const [form, setForm]         = useState({ driver: localStorage.getItem("cp_username") || "", plate:"", vehicleType:"", damageType:"", description:"", photo: null as string | null });
  const [plateCustom, setPlateCustom] = useState(false);
  ...
  const [userActivityLog, setUserActivityLog] = useState<{username:string;role:string;logged_at:string}[]>([]);
  ...
  const pingPresence = useCallback(async () => {
    const name = localStorage.getItem("cp_username"); if (!name) return;
    await sbFetch("presence", {
      method: "POST",
      headers: { "Prefer": "resolution=merge-duplicates,return=minimal" },
      body: JSON.stringify({ username: name, last_seen: new Date().toISOString() }),
    }).catch(() => {});
  }, []);

  const fetchActiveUsers = useCallback(async () => {
    const since = new Date(Date.now() - 2 * 60 * 1000).toISOString();
    const data = await sbFetch(`presence?last_seen=gte.${since}&select=username&order=last_seen.desc`).catch(() => []);
    setActiveUsers((data || []).map((r: { username: string }) => r.username));
  }, []);

  useEffect(() => {
    if (!userName) return;
    pingPresence(); fetchActiveUsers();
    const t = setInterval(() => { pingPresence(); fetchActiveUsers(); }, 30000);
    return () => clearInterval(t);
  }, [userName, pingPresence, fetchActiveUsers]);
  ...
  // Come goHome, ma resta nella sezione admin invece di disconnettere l'admin
  const goAdmin = useCallback((toastData?: { title: string; sub: string } | null) => {
    setView("admin"); setSelected(null);
    if (toastRef.current) clearTimeout(toastRef.current);
    if (toastData) {
      setToast({ ...toastData, id: Date.now() });
      toastRef.current = setTimeout(() => setToast(null), 5000);
  ...
  // Richiedi permesso notifiche + registra token FCM — tutto silenzioso all'avvio
  useEffect(() => {
    // Solo se permesso già concesso in precedenza, re-registra silenziosamente
  ...
  useEffect(() => { setForm(f => ({ ...f, driver: userName })); }, [userName]);
  // Log accesso all'avvio — registra tutti gli utenti che aprono l'app, non solo chi fa login
  useEffect(() => {
    const name = localStorage.getItem("cp_username");
    const role = localStorage.getItem("cp_role") || "operator";
    if (name) logUserActivity(name, role).catch(() => {});
  }, []);
  ...
  async function handleSetName(name: string, preselectedRole?: Role) {
    ...
    // Log accesso per superadmin
    logUserActivity(name, role).catch(() => {});
  }
  ...
  async function handleSave() {
    ...
    try {
      const id = genId();
      const rep: Report = { id, driver: userName || form.driver.trim(), plate:form.plate.trim().toUpperCase(), vehicleType:form.vehicleType, damageType:form.damageType, description:form.description.trim(), date:new Date().toISOString(), photo:form.photo, hasPhoto:!!form.photo };
      await insertReport(rep);
      playNewReportSound();
      setReports(prev => [rep, ...prev]);
      prevReportsLen.current = reports.length + 1;
      setForm({ driver: userName, plate:"", vehicleType:"", damageType:"", description:"", photo:null });
      setErrors({});
  ...
  // ─── Firebase FCM ─────────────────────────────────────────────────────────────
  async function registerFcmToken(showAlerts = false) {
    try {
      if (!("Notification" in window)) { if (showAlerts) alert("Notifiche non supportate su questo browser"); return false; }
      const permission = await Notification.requestPermission();
      if (permission !== "granted") { if (showAlerts) alert("Permesso notifiche negato. Abilitalo dalle impostazioni del telefono."); return false; }
      const messaging = getMessaging(firebaseApp);
      // Registrazione esplicita del service worker (necessaria su iOS PWA)
      ...
      if (!token) { if (showAlerts) alert("Token FCM non ottenuto. Riprova."); return false; }
      setFcmToken(token);
      localStorage.setItem('fcm_token', token); // Salva per persistenza UI
  ...
  async function confirmDelete() {
    ...
    try {
      ...
      setModal(null);
      goAdmin({ title:"SEGNALAZIONE ELIMINATA", sub:`La scheda ${rep.id} è stata rimossa correttamente.` });
      insertMessage("🤖 Sistema", `🗑 Segnalazione eliminata: ${rep.plate} (${rep.vehicleType})`).catch(e=>console.error("notifica chat non inviata", e));
  ...
  async function confirmResolve() {
    ...
    try {
      ...
      setModal(null);
      goAdmin({ title:"GUASTO RISOLTO", sub:`La scheda ${rep.id} è stata spostata nello storico risolti.` });
      insertMessage("🤖 Sistema", `✅ Guasto risolto: ${rep.plate} (${rep.vehicleType}) — ${rep.damageType}${note?" — Note: "+note:""}`).catch(e=>console.error("notifica chat non inviata", e));
  ...
  async function confirmDeleteResolved() {
    ...
    try {
      ...
      setModal(null);
      goAdmin({ title:"ELIMINATO DALLO STORICO", sub:`La scheda ${rep.id} è stata rimossa dallo storico.` });
    } catch(e) { console.error(e); alert("Errore nell'eliminazione."); }
    setBusy(false);
  }
  ...
  async function confirmDeleteFuoriUso() {
    ...
    try {
      ...
      setModal(null);
      goAdmin({ title:"MEZZO RIENTRATO", sub:`Il mezzo ${fu.plate} è stato rimosso dalla lista fuori uso.` });
      insertMessage("🤖 Sistema", `✅ Mezzo rientrato: ${fu.plate} (${fu.vehicleType})`).catch(e=>console.error("notifica chat non inviata", e));
    } catch(e) { console.error(e); alert("Errore nell'eliminazione."); }
    setBusy(false);
  }
  ...
  async function handleAddFuoriUso() {
    ...
    try {
      ...
      insertMessage("🤖 Sistema", `🔧 Mezzo fuori uso: ${entry.plate} (${entry.vehicleType}) — ${entry.reason}`).catch(e=>console.error("notifica chat non inviata", e));
  ...
  return (
    <div translate="no" style={{ minHeight:"100vh", background:"var(--bg)", fontFamily:"'Barlow','Barlow Condensed',sans-serif", color:TTEXT }}>
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .notranslate, [translate="no"] { -webkit-user-select:none; }
      ...
      {/* MODAL UTENTI APP — solo superadmin */}
      {showUsersPanel && (
        <div style={{ position:"fixed", inset:0, background:"#000000cc", zIndex:1000, display:"flex", alignItems:"center", justifyContent:"center", padding:16, overflowY:"auto" }}>
          <div style={{ background:"var(--card)", border:`1px solid var(--border)`, borderTop:`3px solid #a855f7`, borderRadius:14, padding:"24px 20px", maxWidth:480, width:"100%", maxHeight:"90vh", overflowY:"auto" }}>
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:20 }}>
              <div style={{ fontFamily:"Barlow Condensed, sans-serif", fontWeight:900, fontSize:20, letterSpacing:2, color:"#a855f7" }}>👥 UTENTI APP</div>
              <button onClick={()=>setShowUsersPanel(false)} style={{ background:"none", border:"none", color:"var(--sub)", fontSize:22, cursor:"pointer" }}>✕</button>
            </div>
            {usersLoading ? (
              <div style={{ textAlign:"center", padding:30, color:"var(--sub)", fontSize:13 }}>⏳ Caricamento...</div>
            ) : (() => {
              // Raggruppa per username: mostra ultimo accesso, ruolo, n° accessi
              const map = new Map<string, {role:string; lastSeen:string; count:number}>();
              userActivityLog.forEach(row => {
                const existing = map.get(row.username);
                if (!existing || row.logged_at > existing.lastSeen) {
                  map.set(row.username, { role: row.role, lastSeen: row.logged_at, count: (existing?.count || 0) + 1 });
                } else {
                  existing.count++;
                }
              });
              const users = Array.from(map.entries()).sort((a,b) => b[1].lastSeen.localeCompare(a[1].lastSeen));
              const roleColor = (r:string) => r==='superadmin'?"#a855f7":r==='admin'?"#fbbf24":r==='capoturno'?"#22c55e":"#64748b";
              const roleIcon  = (r:string) => r==='superadmin'?"🔱":r==='admin'?"🔐":r==='capoturno'?"⚓":"👷";
              const fmtDate   = (iso:string) => { const d=new Date(iso); return d.toLocaleDateString("it-IT",{day:"2-digit",month:"short"})+" "+d.toLocaleTimeString("it-IT",{hour:"2-digit",minute:"2-digit"}); };
              return users.length === 0 ? (
                <div style={{ textAlign:"center", padding:30, color:"var(--sub)", fontSize:13 }}>Nessun accesso registrato ancora</div>
              ) : (
                <>
                  <div style={{ fontSize:11, color:"var(--sub)", letterSpacing:1, marginBottom:12, fontWeight:700 }}>UTENTI UNICI: {users.length} · ACCESSI TOTALI: {userActivityLog.length}</div>
                  <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                    {users.map(([name, info]) => (
                      <div key={name} style={{ display:"flex", alignItems:"center", gap:12, background:"var(--input-bg)", borderRadius:10, padding:"12px 14px", border:`1px solid var(--border)` }}>
                        <div style={{ fontSize:22 }}>{roleIcon(info.role)}</div>
                        <div style={{ flex:1, minWidth:0 }}>
                          <div style={{ fontFamily:"Barlow Condensed, sans-serif", fontWeight:800, fontSize:16, color:"var(--text-bright)", letterSpacing:0.5 }}>{name}</div>
                          <div style={{ fontSize:11, color:"var(--sub)", marginTop:2 }}>
                            <span style={{ color:roleColor(info.role), fontWeight:700, textTransform:"uppercase" }}>{info.role}</span>
                            {" · "}{fmtDate(info.lastSeen)}
                          </div>
                        </div>
                        <div style={{ textAlign:"right", flexShrink:0 }}>
                          <div style={{ fontSize:18, fontWeight:900, color:"#a855f7", fontFamily:"Barlow Condensed, sans-serif" }}>{info.count}</div>
                          <div style={{ fontSize:10, color:"var(--sub)" }}>accessi</div>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div style={{ fontSize:10, color:"var(--sub)", marginTop:16, textAlign:"center" }}>Ogni accesso / cambio ruolo viene registrato · Visibile solo a superadmin</div>
          </div>
        </div>
      )}
      ...
      <header style={{ background:darkMode?"linear-gradient(135deg,#060d1a,#0a1628)":"linear-gradient(135deg,#1a3a5c,#1e4976)", borderBottom:`3px solid ${ORANGE}`, padding:"0 12px", height:68, display:"flex", alignItems:"center", justifyContent:"space-between", position:"sticky", top:0, zIndex:100, boxShadow:"0 4px 24px #00000088", gap:8 }}>
        <div className="header-left" style={{ display:"flex", alignItems:"center", gap:10, minWidth:0, flexShrink:1 }}>
          {view !== "dashboard" && (
            <button className="back-btn" onClick={()=>{ playClick("soft"); (isAdmin && view!=="admin") ? goAdmin(null) : goHome(null); }} style={{ background:"none", border:"none", color:"var(--sub)", fontSize:24, cursor:"pointer", lineHeight:1, transition:"color .15s", padding:"4px 8px", flexShrink:0 }}>←</button>
          )}
        ...
        <div style={{ display:"flex", gap:5, alignItems:"center", flexShrink:0 }}>
            ...
            {showMenu && (
              <>
                ...
                <div style={{ position:"absolute", top:"calc(100% + 8px)", right:0, zIndex:200, background:"var(--card)", border:`1px solid var(--border)`, borderRadius:12, boxShadow:"0 8px 32px #00000044", minWidth:200, overflow:"hidden" }}>
                  ...
                  {isSuperAdmin && (
                    <button onClick={async ()=>{ playClick("soft"); setShowMenu(false); setUsersLoading(true); setShowUsersPanel(true);
                      try { const d = await getUserActivity(); setUserActivityLog(d as {username:string;role:string;logged_at:string}[]); } catch(e){ console.error(e); } finally { setUsersLoading(false); } }}
                      style={{ ...btn, width:"100%", display:"flex", alignItems:"center", gap:12, padding:"13px 16px", background:"transparent", border:"none", borderBottom:`1px solid var(--border)`, color:"var(--text)", fontSize:13, textAlign:"left" as const, cursor:"pointer" }}>
                      <span style={{ fontSize:18 }}>👥</span>
                      <div>
                        <div style={{ fontWeight:700, letterSpacing:0.5 }}>Utenti App</div>
                        <div style={{ fontSize:10, color:"var(--sub)" }}>Log accessi — solo superadmin</div>
                      </div>
                    </button>
                  )}
                  {/* Notifiche Push FCM */}
                  <button onClick={()=>{ playClick("soft"); setShowMenu(false); registerFcmToken(true).then(ok=>{ if(ok) alert("✅ Notifiche attivate!"); }); }}
                    style={{ ...btn, width:"100%", display:"flex", alignItems:"center", gap:12, padding:"13px 16px", background:"transparent", border:"none", borderBottom:`1px solid var(--border)`, color:"var(--text)", fontSize:13, textAlign:"left" as const, cursor:"pointer" }}>
          ...
          {view === "dashboard" && <>
            {canAdminPanel ? (
              <button onClick={()=>{ playClick("soft"); setIsAdmin(true); setView("admin"); }} style={{ ...btn, background:"transparent", color:"#fbbf24", border:`1px solid #fbbf2466`, borderRadius:7, padding:"7px 9px", fontSize:14 }} title="Pannello Admin">🔧</button>
            ) : (
          ...
          {activeUsers.length > 0 && (
            <div style={{ position:"relative", marginLeft:8 }}>
              <button onClick={()=>setShowActiveUsers(v=>!v)}
                style={{ background:"transparent", border:`1px solid ${GREEN}44`, borderRadius:4, padding:"3px 8px", cursor:"pointer", fontSize:10, color:GREEN, fontFamily:"Barlow Condensed, sans-serif", fontWeight:700, letterSpacing:1 }}>
                🟢 {activeUsers.length} online
              </button>
              {showActiveUsers && (
                <>
                  <div onClick={()=>setShowActiveUsers(false)} style={{ position:"fixed", inset:0, zIndex:299 }}/>
                  <div style={{ position:"absolute", top:"calc(100% + 6px)", left:0, zIndex:300, background:"var(--card)", border:`1px solid var(--border)`, borderRadius:10, padding:"10px 14px", minWidth:160, boxShadow:"0 4px 20px #00000044" }}>
                    <div style={{ fontSize:10, color:"var(--sub)", fontWeight:700, letterSpacing:1, marginBottom:8 }}>UTENTI ATTIVI</div>
                    {activeUsers.map(u => (
                      <div key={u} style={{ fontSize:12, color:"var(--text)", padding:"4px 0", borderBottom:`1px solid var(--border)`, display:"flex", alignItems:"center", gap:6 }}>
                        <span style={{ width:6, height:6, borderRadius:"50%", background:GREEN, display:"inline-block", flexShrink:0 }}/>
                        {u}{u === userName ? " (tu)" : ""}
                      </div>
                    ))}
                  </div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              <div style={{ display:"flex", gap:12, flexWrap:"wrap" }}>
                <div style={{ flex:1, minWidth:180 }}>
                  ...
                  <div style={{ background:"var(--input-bg)", border:`1px solid ${BORDER}`, borderRadius:8, padding:"12px 14px", fontSize:14, color:"#cce0f5", display:"flex", alignItems:"center", gap:8 }}>
                    <span style={{ fontSize:16 }}>👤</span>
                    <span style={{ fontWeight:600 }}>{userName || "—"}</span>
                    <span style={{ fontSize:11, color:"#2a4a6e", marginLeft:"auto" }}>auto</span>
                  </div>
                </div>
              </div>
              <div>
                <Label text="Tipo di Mezzo *"/>
                <select value={form.vehicleType} onChange={e=>{ const cat=e.target.value; setForm(f=>({...f,vehicleType:cat,plate:""})); setPlateCustom(false); }}
              ...
              <div>
                ...
                <MezzoSelect value={form.plate} isCustom={plateCustom} error={errors.plate} accent={ORANGE} category={form.vehicleType} mezziList={allMezzi}
                  ...
                  onCustomChange={v=>setForm(f=>({ ...f, plate:v }))}/>
                  ...
                  <div style={{ background:"var(--fuori-uso-bg)", border:"1px solid var(--fuori-uso-text)33", borderRadius:10, padding:"16px", display:"flex", flexDirection:"column", gap:12 }}>
                    <div style={{ display:"flex", gap:10, flexWrap:"wrap" }}>
                      <div style={{ flex:1, minWidth:150 }}>
                        ...
                        <select value={fuForm.vehicleType} onChange={e=>{ const cat=e.target.value; setFuForm(f=>({...f,vehicleType:cat,plate:""})); setFuPlateCustom(false); }}
                      ...
                      <div style={{ flex:1, minWidth:130 }}>
                        ...
                        <MezzoSelect value={fuForm.plate} isCustom={fuPlateCustom} error={fuErrors.plate} accent={YELLOW} category={fuForm.vehicleType} mezziList={allMezzi}
                          ...
                          onCustomChange={v=>setFuForm(f=>({ ...f, plate:v }))}/>
