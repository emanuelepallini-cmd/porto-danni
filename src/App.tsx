        ...
        <div className="header-left" style={{ display:"flex", alignItems:"center", gap:10, minWidth:0, flexShrink:1 }}>
          ...
          <div className="header-text" style={{ minWidth:0, overflow:"hidden" }}>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:6 }}>
              ...
              <span style={{ fontSize:8, fontWeight:800, color:"#1e3a5f", background:"#0a1628", border:`1px solid #162035`, borderRadius:4, padding:"1px 5px", letterSpacing:1, flexShrink:0 }}>{APP_VERSION}</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ position:"fixed", inset:0, background:"#000000dd", zIndex:1000, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }}>
          <div style={{ background:"#0a1525", border:`1px solid ${RED}55`, borderTop:`3px solid ${RED}`, borderRadius:14, padding:"28px 24px", maxWidth:380, width:"100%", boxShadow:"0 20px 60px #00000099" }}>
            <div style={{ textAlign:"center", marginBottom:20 }}>
              ...
              <div style={{ fontSize:13, color:"#7bacd4", lineHeight:1.6 }}>
            ...
            <div style={{ marginBottom:16 }}>
              <div style={{ fontSize:11, color:"#3b6fa0", letterSpacing:1.5, fontWeight:700, marginBottom:8 }}>🔑 PASSWORD DI RESET</div>
              <input
                type="password"
                value={resetPwd}
                onChange={e=>{ setResetPwd(e.target.value); setResetPwdErr(false); }}
                placeholder="Inserisci la password speciale…"
                style={{ width:"100%", background:"#060d1a", color:"#e2eaf5", border:`1px solid ${resetPwdErr?RED:BORDER}`, borderRadius:8, padding:"12px 14px", fontSize:14, fontFamily:"inherit", boxSizing:"border-box" }}
              />
            ...
            <div style={{ display:"flex", gap:10 }}>
              <button onClick={()=>{ setShowReset(false); setResetPwd(""); setResetPwdErr(false); }}
                style={{ ...btn, flex:1, background:"transparent", border:`1px solid ${BORDER}`, color:"#3b6fa0", borderRadius:8, padding:"12px", fontSize:13 }}>
                Annulla
              </button>
